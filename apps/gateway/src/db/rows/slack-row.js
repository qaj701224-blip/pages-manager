...
export function memoryToRow(memory) {
  return {
    ...
    repo_question_context_json: toDbJson(memory.repoQuestionContext || {}),
    conversation_context_json: toDbJson(memory.conversationContext || {}),
...
export function rowToMemory(row) {
  ...
  return {
    ...
    repoQuestionContext: fromDbJson(row.repo_question_context_json, {}),
    conversationContext: fromDbJson(row.conversation_context_json, {}),
