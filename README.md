...
- 发布必须通过 CLI login 签发的 access key、显式 access key 或受信 Cindy connection assertion 强认证。
...
- Access key、cookie、SSO code、Cloudflare token、secret value 和平台能力不得写入项目文件、日志、README、截图或聊天消息。
