...
test('production pages-api config renders explicit production template values only', () => {
  ...
  assert.match(config, /SITE_METADATA_MUTATIONS_ENABLED = "false"/);
...
test('pages-api metadata mutations stay disabled until each environment template is explicitly enabled', () => {
