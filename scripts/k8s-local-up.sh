...
patch_config_value PAGES_PLATFORM_WORKFLOW_REF "${PAGES_PLATFORM_WORKFLOW_REF:-}"
patch_config_value PAGES_PLATFORM_BASE_REF "${PAGES_PLATFORM_BASE_REF:-${PAGES_PLATFORM_PR_BASE_REF:-}}"
patch_config_value PAGES_PREVIEW_MODE "${PAGES_PREVIEW_MODE:-}"
patch_config_value PAGES_PREVIEW_IP_RESTRICT "${PAGES_PREVIEW_IP_RESTRICT:-true}"
